...
TxArrayType = 'ULA';Nt = 1;dTxAnt = 0.5;Wt = 1;theta_3dB_TX = 10;phi_3dB_TX = 10;
RxArrayType = 'ULA';Nr = 1;dRxAnt = 0.5;Wr = 4;theta_3dB_RX = 10;phi_3dB_RX = 10;
...
d_update = 0.5;
movDistance = 10; % Moving distance, unit of meter
velocity = 1;
...
%% Directional CIR for each channel snapshot(max power方向的)
DirPDPInfo = [];
for i_snap = 1:numberOfSnapshot 
    CIR_tmp = CIR_SISO_EVO.(['Snapshot',num2str(i_snap)]);
    ...
    [maxP, maxIndex] = max(ps(:,2)); % pathPowers
    ...
    % Get directive antenna gains(maxIndex)
